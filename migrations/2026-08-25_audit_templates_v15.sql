...
-- tab. Every question, category, weight, condition and action hint below
-- is copied unchanged from the reference migration
-- 20260825_audit_templates_v15_refresh.sql — except max_value and each
-- option's points, corrected here (see below).
--
...
--
-- Conditions: a positive condition scores the question's full marks and a
-- negative one scores zero. The auditor picks one (option_mode 'radio'
-- throughout the sheet — it doesn't use 'checkbox'). The pick is
-- snapshotted onto audit_responses (option_id/option_text) so a filed
-- audit keeps the exact wording chosen even if the master option list is
-- edited later.
--
-- Points vs. weightage: the source sheet carries separate "Weight (/100)"
-- and "Points" columns per question, and on many rows they didn't agree
-- (e.g. the store-music question: weight 15, points 12) — confirmed with
-- the user this was a sheet error, not intentional partial credit, and
-- the Weight column is the one that's final. Every option in the sheet
...
VALUES (@cat, 'Is the store music on and playing the right way?', 'value', 'radio', 15.00, 15, 1, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Music is on, with the correct playlist and volume during opening hours', 'No action', 15.00, 1),
  (@prm, 'Music is off because of a fault, and a ticket is already raised', 'Check the fault ticket number', 15.00, 2),
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'How did the staff behave with customers?', 'value', 'radio', 20.00, 20, 2, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Polite and helpful, no complaints', 'Check that no CRM complaint is open', 20.00, 1),
  (@prm, 'Small slip, fixed on the spot', 'Note the coaching you gave', 20.00, 2),
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Are there any suspicious numbers in the reward points data?', 'value', 'radio', 15.00, 15, 3, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'No suspicious numbers found in the reward points data', 'No action', 15.00, 1),
  (@prm, 'Suspicious numbers found (possible misuse)', 'Note the numbers and report them', 0.00, 2);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the stock set as per the planogram and are all price tags visible?', 'value', 'radio', 25.00, 25, 4, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Set exactly as per planogram, and every tag is there and easy to read', 'Add a photo of the display', 25.00, 1),
  (@prm, 'Small changes or a few tags missing, fixed during the audit or a ticket raised', 'Write a note or check the ticket number', 25.00, 2),
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the ambience set up as per SOP?', 'value', 'radio', 15.00, 15, 6, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Ambience is set up as per SOP', 'Add a photo', 15.00, 1),
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the brand signage working and clean?', 'value', 'radio', 20.00, 20, 1, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Lit up, working and clean', 'Add a photo', 20.00, 1),
  (@prm, 'Not working, but a ticket is raised', 'Check the ticket number', 20.00, 2),
  (@prm, 'Not working or dirty, and no ticket raised', 'Add a photo', 0.00, 3);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the CCTV working?', 'value', 'radio', 20.00, 20, 2, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Working, and recording is available', 'Check the last recording date', 20.00, 1),
  (@prm, 'Not working, but a ticket is raised', 'Check the ticket number', 20.00, 2),
  (@prm, 'Not working, and no ticket raised', 'Write a note', 0.00, 3);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the pastry counter working and clean?', 'value', 'radio', 15.00, 15, 3, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Working, and temperature is as per SOP', 'Add a photo of the temperature display', 15.00, 1),
  (@prm, 'Not working, but a ticket is raised', 'Check the ticket number', 15.00, 2),
  (@prm, 'Not working, and no ticket raised', 'Write a note', 0.00, 3);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the TV working?', 'value', 'radio', 5.00, 5, 4, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Working, and image is as per SOP', 'Add a photo of the screen', 5.00, 1),
  (@prm, 'Not working, but a ticket is raised', 'Check the ticket number', 5.00, 2),
  (@prm, 'Not working, and no ticket raised', 'Write a note', 0.00, 3),
  (@prm, 'Not available at this outlet', 'Write a note', 5.00, 4);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the printer working?', 'value', 'radio', 5.00, 5, 5, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the computer working?', 'value', 'radio', 5.00, 5, 6, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the air curtain working?', 'value', 'radio', 5.00, 5, 7, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the puff warmer working and clean?', 'value', 'radio', 5.00, 5, 8, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Working, clean, and operated as per SOP', 'Add a photo', 5.00, 1),
  (@prm, 'Not working, but a ticket is raised', 'Check the ticket number', 5.00, 2),
  (@prm, 'Not working, and no ticket raised', 'Write a note', 0.00, 3),
  (@prm, 'Not available at this outlet', 'Note that it\'s not installed', 5.00, 4);
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the AC set to 24-26 C?', 'value', 'radio', 10.00, 10, 11, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Set between 24 and 26 C', 'Add a photo of the remote or AC display', 10.00, 1),
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Procurement handling as per SOP', 'value', 'radio', 55.00, 55, 1, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Are GI/GR issues sorted within a day? Dispatch/assembly/Trade Store GI/GR still pending.', 'No action', 55.00, 1),
  (@prm, 'Are GI/GR issues sorted within a day? Outlet-to-outlet GI/GR still pending after a day', 'Write a note', 0.00, 2);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Storage handling as per SOP', 'value', 'radio', 40.00, 40, 2, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Is the cream kept in a covered box? Kept in a paper or plastic box', 'Add a photo', 40.00, 1),
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Are the staff wearing crocs (footwear)?', 'value', 'radio', 5.00, 5, 3, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the staff\'s hair neat and well-groomed (shave, hairstyle)?', 'value', 'radio', 10.00, 10, 4, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Yes', NULL, 10.00, 1),
  (@prm, 'No', 'Add a photo', 0.00, 2);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Are the staff\'s nails properly trimmed?', 'value', 'radio', 5.00, 5, 5, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Are the staff wearing their caps properly?', 'value', 'radio', 5.00, 5, 6, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the staff well-trained, with no training gaps noticed?', 'value', 'radio', 10.00, 10, 8, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Does the staff seem well-motivated, with no concerns noticed?', 'value', 'radio', 5.00, 5, 9, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Yes', 'No action', 5.00, 1),
  (@prm, 'No', 'Add remarks', 0.00, 2);
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is garbage cleared regularly?', 'value', 'radio', 10.00, 10, 1, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Garbage cleared, area is clean', 'Add a photo', 10.00, 1),
  (@prm, 'Garbage not cleared, area is dirty', 'Add a photo', 0.00, 2);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the customer washroom and wash basin clean and hygienic?', 'value', 'radio', 15.00, 15, 2, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Clean and hygienic', 'Add a photo', 15.00, 1),
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Are the ceiling, platform and floor clean?', 'value', 'radio', 15.00, 15, 4, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'All of it is clean', 'Add a photo', 15.00, 1),
  (@prm, 'Partly clean', 'Add a photo and note what\'s pending', 15.00, 2),
  (@prm, 'Not clean', 'Add a photo', 0.00, 3);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Are the pastry trays clean?', 'value', 'radio', 20.00, 20, 5, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Clean', 'Add a photo', 20.00, 1),
  (@prm, 'Not clean', 'Add a photo', 0.00, 2);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the cash counter clean and tidy?', 'value', 'radio', 10.00, 10, 6, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Clean and tidy', 'Add a photo', 10.00, 1),
  (@prm, 'Not clean', 'Add a photo', 0.00, 2);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Are cleaning supplies (liquid cleaner, broom, mop, microfibre cloth) available in sufficient quantity?', 'value', 'radio', 5.00, 5, 7, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the outlet\'s civil infrastructure in good condition (no repair needed)?', 'value', 'radio', 5.00, 5, 8, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Yes or ticket raised', 'No action', 5.00, 1),
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the store music on and playing the right way?', 'value', 'radio', 30.00, 30, 1, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Music is on, with the correct playlist and volume during opening hours', 'No action', 30.00, 1),
  (@prm, 'Music is off because of a fault, and a ticket is already raised', 'Check the fault ticket number', 30.00, 2),
  (@prm, 'Music is off on purpose (no fault)', 'Write why it was turned off', 0.00, 3),
  (@prm, 'Music is on but wrong (wrong volume, wrong playlist, or off during opening hours)', 'Write what was wrong', 0.00, 4);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the stock set as per the planogram and are all price tags visible?', 'value', 'radio', 35.00, 35, 2, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Set exactly as per planogram, and every tag is there and easy to read', 'Add a photo of the display', 35.00, 1),
  (@prm, 'Small changes or a few tags missing, fixed during the audit or a ticket raised', 'Write a note or check the ticket number', 35.00, 2),
  (@prm, 'Not set as per planogram, or tags missing/wrong with no ticket', 'Add a photo of the display', 0.00, 3);
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the ambience set up as per SOP?', 'value', 'radio', 20.00, 20, 4, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Ambience is set up as per SOP', 'Add a photo', 20.00, 1),
  (@prm, 'Ambience is not set up as per SOP', 'Add a photo and write what\'s off', 0.00, 2);
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Do the system cash, counter cash and banking tally?', 'value', 'radio', 40.00, 40, 1, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'System cash, counter cash and banking all match (tallied)', 'Attach the deposit slip', 40.00, 1),
  (@prm, 'A difference exists, but a voucher or pending bill from staff is available', 'Attach the voucher or pending bill', 40.00, 2),
  (@prm, 'Cash is short with nothing to explain it', 'Write the short amount', 0.00, 3);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the manual bill book maintained properly, with all cash-memo pages present and in order?', 'value', 'radio', 25.00, 25, 2, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'All cash-memo pages are present and in order, and the bill book is up to date', 'No action', 25.00, 1),
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Was the expense voucher made and sent to HO within 15 days?', 'value', 'radio', 20.00, 20, 3, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Made and sent to HO within 15 days', 'No action', 20.00, 1),
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the brand signage working and clean?', 'value', 'radio', 15.00, 15, 1, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Lit up, working and clean', 'Add a photo', 15.00, 1),
  (@prm, 'Not working, but a ticket is raised', 'Check the ticket number', 15.00, 2),
  (@prm, 'Not working or dirty, and no ticket raised', 'Add a photo', 0.00, 3);
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the AC filter cleaned properly?', 'value', 'radio', 10.00, 10, 11, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Filter cleaned (ladder was available)', 'Add a photo', 10.00, 1),
  (@prm, 'Filter not cleaned', 'Write a note', 0.00, 2);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the AC set to 24-26 C?', 'value', 'radio', 10.00, 10, 12, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Procurement handling as per SOP', 'value', 'radio', 10.00, 10, 2, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Are GI/GR issues sorted within a day? Dispatch/assembly/Trade Store GI/GR still pending.', 'No action', 10.00, 1),
  (@prm, 'Are GI/GR issues sorted within a day? Outlet-to-outlet GI/GR still pending after a day', 'Write a note', 0.00, 2);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Storage handling as per SOP', 'value', 'radio', 5.00, 5, 3, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Is the cream kept in a covered box? Kept in a paper or plastic box', 'Add a photo', 5.00, 1),
  (@prm, 'Is the cream kept in a covered box? Left open or on a paper plate', 'Add a photo', 0.00, 2);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Was the finished goods stock count done (anything short)?', 'value', 'radio', 15.00, 15, 4, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Count done, nothing short', 'No action', 15.00, 1),
  (@prm, 'Count not done, or something is short', 'Write the difference', 0.00, 2);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Was the trading goods stock count done (anything short)?', 'value', 'radio', 15.00, 15, 5, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the advance order book kept properly?', 'value', 'radio', 10.00, 10, 6, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Is the staff in proper uniform (uniform, belt, grooming)?', 'value', 'radio', 30.00, 30, 2, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'Full uniform, crocs, belt and grooming all good', 'Add a photo', 30.00, 1),
  (@prm, 'Not in proper uniform', 'Add a photo', 0.00, 2);

INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Are the staff wearing crocs (footwear)?', 'value', 'radio', 10.00, 10, 3, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
...
INSERT INTO `audit_parameters`
  (`category_id`, `parameter_text`, `type`, `option_mode`, `max_value`, `score_weightage`, `sort_order`, `is_active`)
VALUES (@cat, 'Are the ceiling, platform and floor clean?', 'value', 'radio', 20.00, 20, 4, 1);
SET @prm := LAST_INSERT_ID();
INSERT INTO `audit_parameter_options`
  (`parameter_id`, `option_text`, `action_hint`, `points`, `sort_order`)
VALUES
  (@prm, 'All of it is clean', 'Add a photo', 20.00, 1),
  (@prm, 'Partly clean', 'Add a photo and note what\'s pending', 20.00, 2),
  (@prm, 'Not clean', 'Add a photo', 0.00, 3);
