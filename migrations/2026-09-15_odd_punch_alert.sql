...
-- The report and the alert group punches on the cutoff the punch devices
-- themselves use, so make sure the key exists. 6 puts the end of the shift at
-- 05:59:59, which is where the device API writes its auto-close OUT.
INSERT IGNORE INTO `system_settings` (`setting_key`, `setting_value`, `description`) VALUES
  ('ShiftCutoffHour', '6',
